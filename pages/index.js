...
function ModeSelectionScreen({ mob, onSelectEasy, onSelectFree }) {
  ...
  return React.createElement("div", { style: { position: 'fixed', inset: 0, zIndex: 200, background: T.bg, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: mob ? '64px 20px 24px' : 40, overflowY: 'auto' } },
    React.createElement("style", null, `
      ...
      @keyframes flowPulse { 0%,100% { transform: scale(1); box-shadow: 0 0 0 0 rgba(99,102,241,0); background: rgba(99,102,241,0.12); } 50% { transform: scale(1.12); box-shadow: 0 0 16px 4px rgba(99,102,241,0.25); background: rgba(99,102,241,0.22); } }
    `),
    // Section 1: Logo + copy
    React.createElement("div", { style: { textAlign: 'center' } },
    ...
    React.createElement("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: mob ? 6 : 16 } },
      flowSteps.map((s, i) => React.createElement(React.Fragment, { key: i },
        React.createElement("div", {
          ...
          React.createElement("div", { style: { width: mob ? 36 : 52, height: mob ? 36 : 52, borderRadius: '50%', background: 'rgba(99,102,241,0.12)', border: `1.5px solid rgba(99,102,241,0.25)`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: mob ? 16 : 24, animation: `flowPulse 4.5s ease-in-out ${1.5 + i * 1.5}s infinite` } }, s.icon),
