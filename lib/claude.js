...
## 커버 카드 (첫 번째 항목, type: "cover")
- 배열의 첫 번째 항목은 반드시 커버 카드 (type: "cover")
- 전체 카드뉴스의 대표 이미지/영상 역할 — 나머지 카드 내용을 짐작하게 하는 카드
- 영상에서 가장 임팩트 있는 장면이거나, 영상의 핵심 주제를 대표하는 구간
- 제목: 전체 카드뉴스를 관통하는 핵심 한 줄 (호기심 유발)
- 부제목: 영상 제목 또는 핵심 맥락
- 본문: 없음 (빈 문자열)

## 하이라이트 카드 (나머지 항목, type: "highlight")
- 바이럴 점수가 높은 순으로 정렬
