...
const ARTICLE_STYLE_PRESETS = {
  stock_photo: {
    label: '스톡 포토',
    stylePrefix: 'Professional commercial stock photograph, crisp sharp focus, high resolution, bright balanced natural lighting, soft diffused shadows, clean modern minimalist setting, generous negative space around subject, neutral polished color grading with natural skin tones, Getty Images Shutterstock editorial style, approachable friendly mood, centered composition, pristine commercial photography quality',
  },
  cinematic_photo: {
    label: '시네마틱 포토',
    stylePrefix: 'Cinematic film photograph, shot on Kodak Portra 400, 35mm lens at f/2.0, shallow depth of field with natural bokeh, soft natural window light, warm balanced tones with gentle highlight roll-off, filmic color grading with organic grain texture, considered composition and narrative framing, editorial magazine aesthetic, atmospheric mood, single subject, minimal clean background, analog film imperfection',
  },
  char_3d: {
    label: '3D 캐릭터',
...
### content (나머지 카드 전부)
- **본문(body)이 주인공**. headline·subtext는 빈 문자열.
- body: 2~4문장 또는 1~2줄의 핵심 문장. 기사 원문의 구체적 내용(사건·인물·수치·인용)을 담음.
- 카드 간 흐름: 기·승·전·결을 따라가며 자연스럽게 이어짐.
- body 글자수: 70~150자 권장, 최대 200자.
- **마지막 카드**는 마무리·요약·액션·출처 안내를 body에 담음 (여전히 body만 사용).
- 예: { "type": "content", "headline": "", "subtext": "", "body": "페넬로페는 시아버지의 수의를 짠다는 핑계로 구혼자들의 청혼을 20년간 미뤘다. 낮에는 천을 짜고, 밤에는 몰래 풀어버리기를 반복하며." }
